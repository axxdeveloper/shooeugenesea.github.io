---
layout: post
title: "升息重回桌面？實質利率算術揭示 Fed 的雙向困局"
...
你會得到什麼：
- 一個用實質利率 (real rate) 判斷貨幣政策實際鬆緊度的可重複框架
- 一個可驗證的關鍵門檻：核心個人消費支出物價指數 (Core PCE) 是否連續高於 3%
- 一個下一個資料點：2 月 26 日公布的 1 月個人收入與支出報告 (Personal Income & Outlays)
...
**第一條因果鏈：實質利率的算術警訊。** 聯邦基金利率中位數約 3.625%，[12 月核心 PCE 年增率 3.0%](https://www.bea.gov/data/personal-consumption-expenditures-price-index-excluding-food-and-energy)（2024 年 6 月以來最高），相減後實質利率僅約 0.6%。達拉斯聯儲總裁 Lorie Logan [2 月 10 日指出](https://www.dallasfed.org/news/speeches/logan/2026/lkl260210)，模型估算的實質中性利率 (r*) 區間為 1.08%-2.09%。0.6% 落在區間下方，意味著政策可能根本沒有產生足夠緊縮。Logan 原話：「我們目前的政策立場可能非常接近中性，對經濟活動與通膨幾乎沒有抑制作用。」這個算術讓紀要中的升息討論從恐嚇戰術變成了數學邏輯上自洽的對話。
...
> **核心判斷：** 升息討論的本質不是鷹派恐嚇，而是實質利率僅 0.6% 的算術後果——在通膨拒絕下行的情境中，Fed 發現自己的「緊縮」可能從未真正緊縮過。
