---
layout: post
title: "矽盾裂痕：半導體地緣角力、CHIPS Act 進入量產期與華為突圍"
date: 2026-02-21 11:00:00 +0800
categories: [macro]
tags: [macro, etf, investing, ai, technology, semiconductor, geopolitics, chips-act, tsmc]
description: "美國 CHIPS Act 已撥出 $330 億補貼，TSMC 亞利桑那二廠提前至 2027 量產 3nm，華為 Ascend 910C 良率突破 40% 並計畫 2026 年產量翻倍至 60 萬顆。分析半導體地緣風險與 SMH、SOXX、TSM、KWEB 等 ETF 策略。"
lang: zh-TW
---
...
我認為市場嚴重低估了半導體供應鏈的地緣脆弱性。TSMC 的台灣產能集中度短期內不可能被美國或日本的新廠取代——亞利桑那三座工廠全部量產後的產能仍不到台灣的 5%。華為的 DUV 路線雖然在技術上令人印象深刻，但 40% 的良率意味著成本是台積電同等級製程的 2-3 倍，在商業上難以大規模替代。真正值得警惕的是鎵鍺禁令的時間窗口：2026 年 11 月到期後若重新禁止，美國半導體製造將面臨關鍵材料斷供。持續觀察：若中國在台海進行大規模軍演（如 2022 年 8 月模式），或鎵鍺禁令在到期前提前恢復，半導體 ETF 可能出現 15-25% 的急跌；反之，若 TSMC 亞利桑那二廠提前量產且 Intel 新 CEO 成功穩定製程路線圖，供應鏈分散化的敘事將支撐估值。
