...
**溢出持續情境（機率 50%）：** AI 資本支出維持高位，CHIPS Act 與基建法案持續撥款，投資/生產端穩健但消費端低迷。GDP 維持 1.5–2.0%，聯準會下半年降息 1–2 次。等權重配置（RSP）結構性優於市值加權（SPY），因寬度擴大但 AI 巨頭估值空間有限。核心風險是市場誤把 AI 溢出當成全面復甦而追高消費股。**失效條件：** AI 資本支出年增率降至個位數。

**溢出擴散情境（機率 25%）：** AI 生產力開始轉化為企業獲利（4:1 比率收斂至 2.5:1），降息早於預期（6 月首次），投資端復甦終於外溢到消費端——就業與薪資成長加速，GDP 回升至 2.5% 以上。小型股與利率敏感板塊為最大受益者。**失效條件：** 消費者信心指數未能回升至 90 以上。

**溢出逆轉情境（機率 25%）：** AI 資本支出循環見頂（hyperscaler 縮減預算），4:1 投入產出比無法收斂，連帶衝擊整條溢出鏈——銅價回落、建築業就業減速、工業股獲利下修。消費端本就脆弱，經濟滑入溫和衰退。整條溢出鏈（工業、小型股、原物料）跌幅將大於大盤，GLD 成為最佳避險資產。**失效條件：** HYG 殖利率飆升突破 7%，信用利差急劇擴大。

### ETF 配置框架

- **SPY**：市值加權仍受 AI 集中風險影響。若 NVIDIA 2 月 25 日財報不如預期，SPY 受拖累將大於 RSP。持有邏輯在溢出持續情境下成立，但上行空間受限於 AI 巨頭估值已充分反映樂觀預期；失效條件是 AI 資本支出見頂導致權值股盈利下修。
- **RSP**：等權重結構天然受益於市場寬度擴大，基準情境下為偏好持倉。持有邏輯是寬度擴大趨勢延續且中型成分股盈利追趕；失效條件是寬度收縮、資金重新集中於 mega-cap。
- **IWM**：小型股領漲，但高度依賴降息兌現。持有邏輯是聯準會下半年啟動降息、利率敏感的小型股估值修復；失效條件是降息落空或延後，屆時融資成本壓力將使近期漲幅回吐。溢出擴散情境下最大受益者。
- **SMH**：半導體估值已在高位，NVIDIA 2 月 25 日財報為關鍵催化劑。毛利率下滑趨勢與客戶集中度（85% 營收來自 6 家客戶）為結構性隱憂。持有邏輯是 AI 資本支出循環持續且 NVIDIA 維持定價能力；失效條件是 hyperscaler 縮減預算或競爭對手侵蝕份額。
- **XLI**：盈利與股價的落差是潛在追趕交易，也可能是價值陷阱。持有邏輯是 CHIPS Act 工廠建設持續且新訂單來源多元化（非半導體比例擴大）；失效條件是 AI 資本支出循環逆轉，工業股作為溢出鏈的一環同步受衝擊。分辨標準：觀察 Q1 新訂單中非半導體相關的比例是否擴大。
- **GLD**：無論通膨或衰退情境均有避險功能。持有邏輯是停滯性通膨風險 + 地緣不確定性 + 降息預期升溫的三重支撐；失效條件是通膨快速回落且成長回升，風險偏好改善削弱避險需求。建議配置 5–10%。
- **0050**：台灣受益於 CHIPS 法案帶動的半導體需求與 AI 硬體供應鏈地位。持有邏輯是全球 AI 硬體需求結構性成長且台灣供應鏈地位難以替代；失效條件是地緣政治風險升級或全球半導體需求週期反轉。維持核心配置但留意估值過熱回調風險。
