...
1.2 **Market-close insight requirement** — For market-close briefs, avoid tape-reading and technical-analysis framing. Must include: (a) at least two cross-asset causal chains, (b) one non-obvious/contrarian insight, and (c) explicit falsification conditions. Terms like MA/KD/RSI/MACD/Bollinger/golden-cross are prohibited.
